...
TOOLS = [
    ...
    },
    {
        ...
        "description": "Google Labs-tool (aangekondigd op Google I/O 2025) voor multi-richting UX-verkenning en voice-canvas-ideation. Geschikt om in de blueprint-fase verschillende interactie-richtingen naast elkaar te leggen voordat één wordt gekozen. Geen backend, dus misleidend voor blueprints met complexe businesslogica; Labs-status maakt productie-roadmap onzeker.",
        "building_blocks": ["Client Blueprint"],
        "guardrails": ["Accountability", "Transparency"],
        "sources": ["https://www.nxcode.io/resources/news/vibe-design-tools-compared-stitch-v0-lovable-2026"],
        "displayed_on": ["Client Blueprint"],
