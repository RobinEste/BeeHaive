...
TOOLS = [
    ...
    },
    {
        ...
        "description": "RAG-evaluatieframework: faithfulness, answer relevancy, context recall en context precision — elk vangt een ander failure-type. LLM-as-judge maakt het schaalbaar naar honderden queries zonder handmatige gold answers.",
    ...
    },
    {
        ...
        "description": "Full agent-runtime met self-editing memory over drie tiers (Core/Recall/Archival, OS-geïnspireerd). Visual debugging via ADE. Python-only; architecturele lock-in — kies bij autonome agents die zelf memory cureren.",
        "building_blocks": ["Dynamic Context", "Tool Integration"],
        "guardrails": ["Accountability"],
