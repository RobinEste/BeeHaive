...
Dit maakt beslissingen auditeerbaar — je kunt achteraf zien *waarom* de agent iets deed — en dwingt de agent om vóór actie expliciet aannames te checken, wat hallucinations (verzonnen feiten die het model als waar presenteert) reduceert.
