...
quickStart:
  - |
    ...
    Alleen op die plekken liggen de kwaliteitscriteria die je expliciet moet externaliseren. Zonder deze keuze blijft alles beneden (operating agreements, training, tooling) vaag, en is investeren in Knowledge verspilling.
  - |
...
1. **Omgeving met hoge voorspelkracht** (*high-validity environment*): stabiele, objectief identificeerbare signalen die voorspellend zijn voor uitkomsten.
2. **Voldoende leerkans** (*adequate opportunity to learn*): oefening met snelle, consistente feedback.

Hun scherpste observatie: *"Subjective experience is not a reliable indicator of judgment accuracy."* Oftewel: het gevoel dat je een oordeel juist hebt, is geen betrouwbaar bewijs dat het ook klopt. Je kunt je zeker voelen over een oordeel dat objectief vaak mis is.

Het AI-tijdperk bedreigt beide voorwaarden. AI verandert de geldigheidsomgeving (signalen waaraan experts hun oordeel kalibreren verschuiven), en het breekt de feedbackloops (de uitkomst wordt aan AI toegeschreven, niet aan de menselijke beslissing). Zonder expliciete tegenmaatregelen raken professionals hun ijkpunt kwijt, terwijl ze subjectief nog even zelfverzekerd blijven.
...
De trust chasm is 52 punten; de tool-adequaatheidsgap 67 punten. En dit is niet omdat de technologie niet werkt. De primaire driver is [**FOBO**](/begrippen#fobo) (Fear of Becoming Obsolete):
