...
- **Claude Design** (Anthropic, gelanceerd 17 april 2026, powered by Claude Opus 4.7): genereert prototypes, slides en one-pagers; past een team-design-system toe door codebase en design-files in te lezen. Gericht op gebruikers die niet uit een design-tool starten. Beschikbaar voor Claude Pro/Max/Team/Enterprise. Zwakte: research-preview, feature-set evolueert nog snel.
