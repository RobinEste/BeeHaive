...
Met deze vijf principes kun je iteratief werken zonder te vervallen in het volledige FDE-model. De helicopter-view-stap is daarbij de bewuste tegenkracht voor de Cagan-kritiek op eenmalige klant-aanpassingen: niet alle FDE-werk wordt een product-feature, maar wat patroon-waardig is wordt actief opgeschaald.

</BBDisclosure>

<BBDisclosure title="Governance, goedkeuring en de Nederlandse context">
