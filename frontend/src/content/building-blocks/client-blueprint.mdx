...
Een waarde-stroom volgens Obeidat kan volledig intern zijn (bijvoorbeeld een maand-afsluiting); volgens Appelo begint en eindigt hij altijd bij een gebruiker of klant. Beide definities zijn werkbaar; de Appelo-versie sluit beter aan op een commerciële AI-toepassing, de Obeidat-versie is praktischer voor interne automatisering.
...
Binnen de gekozen waarde-stroom zoom je in op één werkstroom. Het TRACE-mindset (Trigger, Route, Annotate, Check, Escalate) maakt onzichtbaar werk zichtbaar:
...
- **Embedded scoping**: tijd doorbrengen in de waarde-stroom zelf, met de waarde-stroom-eigenaren, niet alleen met de IT-eigenaar.
