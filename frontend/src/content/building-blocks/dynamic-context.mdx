...
- [Client Blueprint](/framework/client-blueprint) (BB_02: van waarde-stroom naar AI-ontwerp): de blueprint legt vast welke waarde-stroom wordt verbeterd en welke data-grenzen daarbij horen; Dynamic Context geeft daar de retrieval-architectuur aan.
